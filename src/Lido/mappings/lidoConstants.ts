...
import {
  LidoNodeOperatorsRegistryAddress,
  LidoOracleAddress,
  LidoTokenAddress,
  LidoTreasuryAddress,
...
export { LidoOracleAddress, LidoTreasuryAddress, LidoTokenAddress, LidoNodeOperatorsRegistryAddress };
...
export const LIDO_DEPOSIT_SIZE = BigInt.fromI32(32);
export const LIDO_DEPOSIT_AMOUNT = LIDO_DEPOSIT_SIZE.times(ETHER);
export const LIDO_CALCULATION_UNIT = BigInt.fromI32(10000);
export const LIDO_DUST_BOUNDARY = BigInt.fromI32(50000);
