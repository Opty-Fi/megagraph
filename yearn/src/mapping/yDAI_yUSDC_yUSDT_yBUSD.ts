import {
  yearn_yDAI_yUSDC_yUSDT_yBUSD,
  DepositCall,
  WithdrawCall
} from "../../generated/yearn_yDAI_yUSDC_yUSDT_yBUSD/yearn_yDAI_yUSDC_yUSDT_yBUSD"
...
export function updateEntity(
  ...
  let contract = yearn_yDAI_yUSDC_yUSDT_yBUSD.bind(address)
