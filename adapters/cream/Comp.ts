...
export class Comp__checkpointsResult {
  value0: BigInt;
  value1: BigInt;
...
export class Comp extends ethereum.SmartContract {
  static bind(address: Address): Comp {
    return new Comp("Comp", address);
  }
  ...
  checkpoints(param0: Address, param1: BigInt): Comp__checkpointsResult {
    let result = super.call(
      "checkpoints",
    ...
    return new Comp__checkpointsResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_checkpoints(
    param0: Address,
    param1: BigInt
  ): ethereum.CallResult<Comp__checkpointsResult> {
    let result = super.tryCall(
      "checkpoints",
      "checkpoints(address,uint32):(uint32,uint96)",
      [
    ...
    return ethereum.CallResult.fromValue(
      new Comp__checkpointsResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
